class Program
{
    static void Main()
    {
        ...
        var outdoorEvent = new OutdoorGathering("Community Picnic", "A day out in the sun with family and friends", DateTime.Now.AddDays(60), "11 AM", new Address("789 Park Ave", "Lekki", "Lagos", "Nigeria"), "Sunny with a chance of showers");
